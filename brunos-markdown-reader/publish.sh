#!/usr/bin/env bash
# Publish brunos-markdown-reader to the VS Code Marketplace.
#
# Usage:
...
echo ">> Done. Check: https://marketplace.visualstudio.com/items?itemName=$PUBLISHER.brunos-markdown-reader"
